    ...
    return (
      <div className="mb-5">
        ...
        <textarea
          ...
          onChange={(e) => onPatch({ [q.id]: e.target.value } as Partial<LowerLegAdaptiveAnswers>)}
          rows={2}
...
export function ConsultaAdaptiveLowerLeg({
  ...
  const singlePage = sections.length <= 1;
  ...
  return (
    <div>
      ...
      {urgent && !singlePage && currentSection !== "red_flags" && (
      ...
      <h2 className="mb-4 text-xl font-bold tracking-tight text-slate-900">
        {localizeLowerLegSection(currentSection, locale)}
      </h2>
