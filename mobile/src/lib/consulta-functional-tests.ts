...
export const FUNCTIONAL_TEST_QUESTIONS: Record<FunctionalRegionId, string[]> = {
  ...
  ankle: [
    "¿Puedes apoyar el pie completo y dar 4 pasos sin cojera marcada? (compara con el otro lado)",
    "¿Cuántas elevaciones de talón a una sola pierna haces antes del dolor, y con qué altura respecto a la otra?",
    "¿Aguantas 20–30 segundos a la pata coja con ojos abiertos? ¿Y con ojos cerrados (solo si es seguro)?",
