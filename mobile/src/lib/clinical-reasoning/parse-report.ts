import { BODY_PARTS, type BodyPartId } from "../body-parts";
import { findClinicalTestImage } from "../clinical-test-images";
import { detectBodyPartsFromText } from "../detect-body-part";
import type { ParsedManiobraLine } from "./types";
