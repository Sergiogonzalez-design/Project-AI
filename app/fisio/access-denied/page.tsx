...
export default function FisioAccessDeniedPage() {
  return (
    <main className="mx-auto max-w-lg px-6 py-16 text-center">
      <h1 className="text-xl font-semibold text-neutral-900">
        Sin acceso al panel de fisioterapeuta
      </h1>
      <p className="mt-3 text-sm leading-relaxed text-neutral-600">
        Esta sección es solo para cuentas registradas como fisioterapeuta.
        Si eres paciente, vuelve a la consulta; si eres fisioterapeuta,
        inicia sesión con esa cuenta.
      </p>
      <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
        <Link
          href="/login?next=%2Ffisio"
