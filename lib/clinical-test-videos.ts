...
export const CLINICAL_TEST_VIDEOS = {
  ...
  "thomas-test": `${CLINICAL_TEST_CDN}/videos/thomas-test.mp4?${VIDEO_CACHE}`,
  "resisted-adduction": `${CLINICAL_TEST_CDN}/videos/resisted-adduction.mp4?${VIDEO_CACHE}`,
  "resisted-hip-flexion": `${CLINICAL_TEST_CDN}/videos/resisted-hip-flexion.mp4?${VIDEO_CACHE}`,
  "resisted-abduction": `${CLINICAL_TEST_CDN}/videos/resisted-abduction.mp4?${VIDEO_CACHE}`,
  "log-roll": `${CLINICAL_TEST_CDN}/videos/log-roll.mp4?${VIDEO_CACHE}`,
  stinchfield: `${CLINICAL_TEST_CDN}/videos/stinchfield.mp4?${VIDEO_CACHE}`,
  "hip-scour": `${CLINICAL_TEST_CDN}/videos/hip-scour.mp4?${VIDEO_CACHE}`,
  "ober-test": `${CLINICAL_TEST_CDN}/videos/ober-test.mp4?${VIDEO_CACHE}`,
  "noble-compression": `${CLINICAL_TEST_CDN}/videos/noble-compression.mp4?${VIDEO_CACHE}`,
  ...
  "biceps-squeeze": `${CLINICAL_TEST_CDN}/videos/biceps-squeeze.mp4?${VIDEO_CACHE}`,
  "chair-push-plri": `${CLINICAL_TEST_CDN}/videos/chair-push-plri.mp4?${VIDEO_CACHE}`,
  ...
  "thigh-thrust": `${CLINICAL_TEST_CDN}/videos/thigh-thrust.mp4?${VIDEO_CACHE}`,
  "si-distraction": `${CLINICAL_TEST_CDN}/videos/si-distraction.mp4?${VIDEO_CACHE}`,
  "si-compression": `${CLINICAL_TEST_CDN}/videos/si-compression.mp4?${VIDEO_CACHE}`,
  "active-slr": `${CLINICAL_TEST_CDN}/videos/active-slr.mp4?${VIDEO_CACHE}`,
  ...
  "flexion-rotation": `${CLINICAL_TEST_CDN}/videos/flexion-rotation.mp4?${VIDEO_CACHE}`,
  bakody: `${CLINICAL_TEST_CDN}/videos/bakody.mp4?${VIDEO_CACHE}`,
  ...
  "press-test": `${CLINICAL_TEST_CDN}/videos/press-test.mp4?${VIDEO_CACHE}`,
