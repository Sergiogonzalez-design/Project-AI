...
const MODULE_SOURCES = {
  ...
  "hamstring-injury.md": "Physioguide — Muslo — isquiotibiales / hamstring",
  ...
  "elbow-osteoarthritis.md": "Physioguide — Codo — artrosis / OA",
  ...
  "spine-master-integration.md": "Physioguide — Raquis — integración maestro cervical/torácico/lumbar",
  ...
  "thoracic-master-integration.md": "Physioguide — Torácico — integración maestro espalda media / pared",
  "thoracic-spine-pain.md": "Physioguide — Torácico — mecánico no específico (TSP)",
  "thoracic-redflags-visceral.md": "Physioguide — Torácico — red flags visceral / fractura / Scheuermann",
  "lumbar-back-pain.md": "Physioguide — Lumbar — mecánico / ciática",
  "lumbar-si-pelvis.md": "Physioguide — Lumbar — sacroilíaca / pelvis (Laslett)",
  ...
  "thoracic-tests.md": "Physioguide — Evidencia — tests torácico / pared torácica",
  "clusters-thoracic.md": "Physioguide — Evidencia — clusters torácico / pared",
  ...
  "shoulder-lateral-referred-differential.md": "Physioguide — Hombro — lateral referido / tests negativos (relations active)",
  "cervical-referred-differential.md": "Physioguide — Cervical — referido / diferencial (relations active)",
  "relations-shoulder-lateral.md": "Physioguide — Relaciones — grafo hombro lateral (active v2)",
  "relations-cervical.md": "Physioguide — Relaciones — grafo cervical (active v2)",
  "lumbar-referred-differential.md": "Physioguide — Lumbar — referido / diferencial (relations active)",
  "hip-referred-differential.md": "Physioguide — Cadera — referido / diferencial (relations active)",
  "relations-lumbar.md": "Physioguide — Relaciones — grafo lumbar (active v2)",
  "relations-hip.md": "Physioguide — Relaciones — grafo cadera (active v2)",
  "relations-knee.md": "Physioguide — Relaciones — grafo rodilla (active v2)",
  "relations-ankle-foot.md": "Physioguide — Relaciones — grafo tobillo/pie (active v2)",
  "relations-thoracic.md": "Physioguide — Relaciones — grafo torácico (active v2)",
  "relations-head.md": "Physioguide — Relaciones — grafo cabeza/cefalea (active v2)",
  "relations-elbow-wrist.md": "Physioguide — Relaciones — grafo codo/muñeca (active v2)",
  ...
  "persistence-prognosis-pathways.md": "Physioguide — Evidencia — historia natural y reevaluación si no mejora",
  "post-surgery-screens-master.md": "Physioguide — Post-cirugía — pantallas maestro (LCA / manguito / tobillo)",
  "post-surgery-acl.md": "Physioguide — Post-cirugía — reconstrucción LCA",
  "post-surgery-meniscus.md": "Physioguide — Post-cirugía — menisco (reparación / meniscectomía)",
  "post-surgery-hip-knee-arthroplasty.md": "Physioguide — Post-cirugía — prótesis cadera / rodilla (THA/TKA)",
  "post-surgery-lumbar.md": "Physioguide — Post-cirugía — lumbar (descompresión / fusión)",
  "post-surgery-rotator-cuff.md": "Physioguide — Post-cirugía — reparación de manguito",
  "post-surgery-ankle.md": "Physioguide — Post-cirugía — tobillo Broström / ORIF",
  "post-surgery-rts-criteria.md": "Physioguide — Evidencia — criterios RTS post-cirugía común",
  "tmj-tmd.md": "Physioguide — Cabeza — ATM / TMD",
  "lower-leg-compartment.md": "Physioguide — Pierna — lower leg / compartimentos / MTSS-CECS",
  "pelvic-floor-pgpain.md": "Physioguide — Pelvis — suelo pélvico / PGP",
  ...
  "cited-diagnostic-accuracy.md": "Physioguide — Evidencia — precisión diagnóstica citada (Wainner / Ottawa / Lachman)",
